...
class UserPaymentReview(models.Model):
    ...
    title = models.CharField(max_length=100, default="Bitcoin")
    initial = models.CharField(max_length=7, default="BTC")
    invested_amount = models.DecimalField(max_digits=99999, decimal_places=2, default="0")
    invested_return = models.DecimalField(max_digits=99999, decimal_places=2, default="0")
