...
class Coin(models.Model):
    ...
    invested_amount = models.DecimalField(max_digits=99999, decimal_places=2, default="0.99")
    invested_return = models.DecimalField(max_digits=99999, decimal_places=2, default="1.99")
